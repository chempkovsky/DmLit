...
import { IaspnetroleViewEdlg } from './../edlg/aspnetrole-view-edlg.interface';
...
export class AspnetroleViewLformComponent implements OnInit, AfterViewInit, IEventEmitterPub, IItemHeightData {
    ...
    onAdd(sender: AspnetroleViewSformComponent) {
        let locdata: IaspnetroleViewEdlg = {
            title: 'Add item',
        ...
        let dialogRef = this.dialog.open(AspnetroleViewEdlgComponent, {
              data: locdata,
              maxWidth: mw,
              width: w,
            });
