...
@Component({
  selector: 'app-lit-country-view-rlist',
  templateUrl: './lit-country-view-rlist.component.html',
  styleUrls: ['./lit-country-view-rlist.component.css']
})
export class LitCountryViewRlistComponent implements OnInit, IEventEmitterPub, IItemHeightData {
