...
import { IaspnetuserrolesViewEdlg } from './../edlg/aspnetuserroles-view-edlg.interface';
import { AspnetuserrolesViewEdlgComponent } from './../edlg/aspnetuserroles-view-edlg.component';


@Component({
  selector: 'app-aspnetuserroles-view-lform',
  templateUrl: './aspnetuserroles-view-lform.component.html',
  styleUrls: ['./aspnetuserroles-view-lform.component.css']
})
export class AspnetuserrolesViewLformComponent implements OnInit, AfterViewInit, IEventEmitterPub, IItemHeightData {
    ...
    constructor(private  frmRootSrv: AspnetuserrolesViewService, protected appGlblSettings: AppGlblSettingsService, public dialog: MatDialog, private cd: ChangeDetectorRef) {
    }
    permMask: number = 0;
    ngOnInit() {
    ...
    onAdd(sender: AspnetuserrolesViewSformComponent) {
        let locdata: IaspnetuserrolesViewEdlg = {
            title: 'Add item',
        ...
        let dialogRef = this.dialog.open(AspnetuserrolesViewEdlgComponent, {
              data: locdata,
              maxWidth: mw,
              width: w,
            });
