...
import { IaspnetmodelViewEdlg } from './../edlg/aspnetmodel-view-edlg.interface';
...
export class AspnetmodelViewLformComponent implements OnInit, AfterViewInit, IEventEmitterPub, IItemHeightData {
    ...
    onAdd(sender: AspnetmodelViewSformComponent) {
        let locdata: IaspnetmodelViewEdlg = {
            title: 'Add item',
        ...
        let dialogRef = this.dialog.open(AspnetmodelViewEdlgComponent, {
              data: locdata,
              maxWidth: mw,
              width: w,
            });
