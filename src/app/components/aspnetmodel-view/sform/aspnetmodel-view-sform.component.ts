...
export class AspnetmodelViewSformComponent implements OnInit, AfterViewInit, IEventEmitterPub, IItemHeightData {
    ...
    displayedColumns:  Array<string> = ['selectAction', 'modelPk', 'modelName', 'modelDescription', 'menuAction'];
    @Input('caption') caption: string = 'aspnetmodelView';
    ...
    @Output('apply-filter') applyFilter: EventEmitter<AspnetmodelViewSformComponent> = new EventEmitter<AspnetmodelViewSformComponent>();


    constructor(private  frmRootSrv: AspnetmodelViewService, protected appGlblSettings: AppGlblSettingsService, protected dialog: MatDialog, private cd: ChangeDetectorRef) {
    }
    ...
    onSelectRow(e: IaspnetmodelView) {
