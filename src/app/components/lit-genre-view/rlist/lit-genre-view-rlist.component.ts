...
@Component({
  selector: 'app-lit-genre-view-rlist',
  templateUrl: './lit-genre-view-rlist.component.html',
  styleUrls: ['./lit-genre-view-rlist.component.css']
})
export class LitGenreViewRlistComponent implements OnInit, IEventEmitterPub, IItemHeightData {
