...
@Component({
  selector: 'app-lit-genre-view-sform',
  templateUrl: './lit-genre-view-sform.component.html',
  styleUrls: ['./lit-genre-view-sform.component.css']
})
export class LitGenreViewSformComponent implements OnInit, AfterViewInit, IEventEmitterPub, IItemHeightData {
    ...
    public dataSource: Array<ILitGenreView> = [];
    matPaginatorLen: number = 0;
    matPaginatorPageSize: number = 10;
    matPaginatorPageSizeOptions: Array<number> = [10, 25, 50, 100];
    displayedColumns:  Array<string> = ['selectAction', 'genreId', 'genreName', 'menuAction'];
    ...
    filterDefs: Array<IWebServiceFilterDef> = [
            {fltrName: 'genreId', fltrCaption: 'Id of the genre',  fltrDataType: 'int32', fltrMaxLen: null, fltrMin: null, fltrMax: null }
           ,  {fltrName: 'genreName', fltrCaption: 'Name of the genre',  fltrDataType: 'string', fltrMaxLen: 20, fltrMin: null, fltrMax: null }
        ];
    ...
    public currentRow: ILitGenreView | null = null;
    @Output('selected-row') selectedRow: EventEmitter<ILitGenreView> = new EventEmitter<ILitGenreView>();
    @Output('apply-filter') applyFilter: EventEmitter<LitGenreViewSformComponent> = new EventEmitter<LitGenreViewSformComponent>();


    constructor(private  frmRootSrv: LitGenreViewService, protected appGlblSettings: AppGlblSettingsService, protected dialog: MatDialog, private cd: ChangeDetectorRef) {
    }
    ...
    onFilter() {
        let flt: ILitGenreViewFilter = { page: this.currentPageIndex, pagesize: this.currentPageSize };
        ...
        this.frmRootSrv.getwithfilter(flt)
            .subscribe((v: ILitGenreViewPage) =>{
                ...
                let currow: ILitGenreView | null = null;
    ...
    rowCommand(e: ILitGenreView, id: string) {
