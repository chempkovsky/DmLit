...
@Component({
  selector: 'app-lit-genre-view-lform',
  templateUrl: './lit-genre-view-lform.component.html',
  styleUrls: ['./lit-genre-view-lform.component.css']
})
export class LitGenreViewLformComponent implements OnInit, AfterViewInit, IEventEmitterPub, IItemHeightData {
    ...
    constructor(private  frmRootSrv: LitGenreViewService, protected appGlblSettings: AppGlblSettingsService, public dialog: MatDialog, private cd: ChangeDetectorRef) {
    }
    permMask: number = 0;
    ngOnInit() {
