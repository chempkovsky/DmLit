...
@Component({
  selector: 'app-lit-manuscript-view-rlist',
  templateUrl: './lit-manuscript-view-rlist.component.html',
  styleUrls: ['./lit-manuscript-view-rlist.component.css']
})
export class LitManuscriptViewRlistComponent implements OnInit, IEventEmitterPub, IItemHeightData {
