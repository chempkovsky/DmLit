...
@Component({
  selector: 'app-lit-manuscript-view-o2m',
  templateUrl: './lit-manuscript-view-o2m.component.html',
  styleUrls: ['./lit-manuscript-view-o2m.component.css']
})
export class LitManuscriptViewO2mComponent implements IEventEmitterPub {
        ...
        let msk: number = 0;
            ...
            if( (msk & 1) === 1 ) {
                this.detailViewSelModels.push({
                    ...
                    foreignKeyName: 'Manuscript',
                    caption: 'LitBookView' + ': ' + 'Manuscript'
                });
            }
    ...
    public mstrRow: ILitManuscriptView | null = null; 
        ...
        switch(this.dtlVw.viewName) {
            ...
            case 'LitBookView':
                        newFlt.push({
                            ...
                            fltrDataType: 'int32',
                            fltrOperator: 'eq',
                            fltrValue: this.mstrRow.manuscriptId
                        });
                break;  
        }
