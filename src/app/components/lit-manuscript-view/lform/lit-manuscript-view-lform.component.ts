...
@Component({
  selector: 'app-lit-manuscript-view-lform',
  templateUrl: './lit-manuscript-view-lform.component.html',
  styleUrls: ['./lit-manuscript-view-lform.component.css']
})
export class LitManuscriptViewLformComponent implements OnInit, AfterViewInit, IEventEmitterPub, IItemHeightData {
    ...
    constructor(private  frmRootSrv: LitManuscriptViewService, protected appGlblSettings: AppGlblSettingsService, public dialog: MatDialog, private cd: ChangeDetectorRef) {
    }
    permMask: number = 0;
    ngOnInit() {
