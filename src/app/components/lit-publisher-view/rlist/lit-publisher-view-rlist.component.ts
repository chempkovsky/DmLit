...
@Component({
  selector: 'app-lit-publisher-view-rlist',
  templateUrl: './lit-publisher-view-rlist.component.html',
  styleUrls: ['./lit-publisher-view-rlist.component.css']
})
export class LitPublisherViewRlistComponent implements OnInit, IEventEmitterPub, IItemHeightData {
