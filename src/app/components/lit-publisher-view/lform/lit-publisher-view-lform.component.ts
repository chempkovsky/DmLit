...
@Component({
  selector: 'app-lit-publisher-view-lform',
  templateUrl: './lit-publisher-view-lform.component.html',
  styleUrls: ['./lit-publisher-view-lform.component.css']
})
export class LitPublisherViewLformComponent implements OnInit, AfterViewInit, IEventEmitterPub, IItemHeightData {
    ...
    constructor(private  frmRootSrv: LitPublisherViewService, protected appGlblSettings: AppGlblSettingsService, public dialog: MatDialog, private cd: ChangeDetectorRef) {
    }
    permMask: number = 0;
    ngOnInit() {
