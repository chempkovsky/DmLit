...
@Component({
  selector: 'app-aspnetdashboard-view-sform',
  templateUrl: './aspnetdashboard-view-sform.component.html',
  styleUrls: ['./aspnetdashboard-view-sform.component.css']
})
export class AspnetdashboardViewSformComponent implements OnInit, AfterViewInit, IEventEmitterPub, IItemHeightData {
    ...
    public dataSource: Array<IaspnetdashboardView> = [];
    matPaginatorLen: number = 0;
    matPaginatorPageSize: number = 10;
    matPaginatorPageSizeOptions: Array<number> = [10, 25, 50, 100];
    displayedColumns:  Array<string> = ['selectAction', 'dashboardPk', 'dashboardName', 'dashboardDescription', 'menuAction'];
    ...
    @Output('apply-filter') applyFilter: EventEmitter<AspnetdashboardViewSformComponent> = new EventEmitter<AspnetdashboardViewSformComponent>();


    constructor(private  frmRootSrv: AspnetdashboardViewService, protected appGlblSettings: AppGlblSettingsService, protected dialog: MatDialog, private cd: ChangeDetectorRef) {
    }
    ...
    onFilter() {
        ...
        this.frmRootSrv.getwithfilter(flt)
            .subscribe((v: IaspnetdashboardViewPage) =>{
                ...
                let currow: IaspnetdashboardView | null = null;
    ...
    rowCommand(e: IaspnetdashboardView, id: string) {
