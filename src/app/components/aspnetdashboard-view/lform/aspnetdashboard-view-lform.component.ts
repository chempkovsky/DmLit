...
import { IaspnetdashboardViewEdlg } from './../edlg/aspnetdashboard-view-edlg.interface';
import { AspnetdashboardViewEdlgComponent } from './../edlg/aspnetdashboard-view-edlg.component';


@Component({
  selector: 'app-aspnetdashboard-view-lform',
  templateUrl: './aspnetdashboard-view-lform.component.html',
  styleUrls: ['./aspnetdashboard-view-lform.component.css']
})
export class AspnetdashboardViewLformComponent implements OnInit, AfterViewInit, IEventEmitterPub, IItemHeightData {
    @Input('caption') caption: string = 'aspnetdashboardView';
    ...
    public currentRow: IaspnetdashboardView | null = null;
    @Output('selected-row') selectedRow: EventEmitter<IaspnetdashboardView> = new EventEmitter<IaspnetdashboardView>();
    ...
    constructor(private  frmRootSrv: AspnetdashboardViewService, protected appGlblSettings: AppGlblSettingsService, public dialog: MatDialog, private cd: ChangeDetectorRef) {
    }
    permMask: number = 0;
    ngOnInit() {
        this.permMask = this.appGlblSettings.getViewModelMask('aspnetdashboardView');
    ...
    onSelectRow(e: IaspnetdashboardView) {
        this.selectedRow.emit(e);
    }



    onAdd(sender: AspnetdashboardViewSformComponent) {
        let locdata: IaspnetdashboardViewEdlg = {
            title: 'Add item',
        ...
        let w: string = this.appGlblSettings.getDialogWidth('aspnetdashboardView');
        let mw: string = this.appGlblSettings.getDialogMaxWidth('aspnetdashboardView');
        let dialogRef = this.dialog.open(AspnetdashboardViewEdlgComponent, {
              data: locdata,
              maxWidth: mw,
              width: w,
            });
    ...
    onDelete(e: IaspnetdashboardView , sender: AspnetdashboardViewSformComponent ) {
        let locdata: IaspnetdashboardViewEdlg = {
            title: 'Delete item',
            hiddenFilter: this.hiddenFilter,
