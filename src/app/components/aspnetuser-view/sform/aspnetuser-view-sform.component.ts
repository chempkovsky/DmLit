...
export class AspnetuserViewSformComponent implements OnInit, AfterViewInit, IEventEmitterPub, IItemHeightData {
    ...
    displayedColumns:  Array<string> = ['selectAction', 'id', 'email', 'emailConfirmed', 'phoneNumber', 'phoneNumberConfirmed', 'twoFactorEnabled', 'lockoutEndDateUtc', 'lockoutEnabled', 'accessFailedCount', 'userName', 'menuAction'];
    ...
    filterDefs: Array<IWebServiceFilterDef> = [
            {fltrName: 'id', fltrCaption: 'User Id',  fltrDataType: 'string', fltrMaxLen: 128, fltrMin: null, fltrMax: null }
           ,  {fltrName: 'email', fltrCaption: 'User Email',  fltrDataType: 'string', fltrMaxLen: 256, fltrMin: null, fltrMax: null }
           ,  {fltrName: 'phoneNumber', fltrCaption: 'Phone Number',  fltrDataType: 'string', fltrMaxLen: null, fltrMin: null, fltrMax: null }
           ,  {fltrName: 'lockoutEndDateUtc', fltrCaption: 'Lockout End Date Utc',  fltrDataType: 'datetime', fltrMaxLen: null, fltrMin: null, fltrMax: null }
           ,  {fltrName: 'userName', fltrCaption: 'User Name',  fltrDataType: 'string', fltrMaxLen: 256, fltrMin: null, fltrMax: null }
        ];
    ...
    @Output('apply-filter') applyFilter: EventEmitter<AspnetuserViewSformComponent> = new EventEmitter<AspnetuserViewSformComponent>();


    constructor(private  frmRootSrv: AspnetuserViewService, protected appGlblSettings: AppGlblSettingsService, protected dialog: MatDialog, private cd: ChangeDetectorRef) {
    }
    ...
    onFilter() {
        let flt: IaspnetuserViewFilter = { page: this.currentPageIndex, pagesize: this.currentPageSize };
        ...
        this.frmRootSrv.getwithfilter(flt)
            .subscribe((v: IaspnetuserViewPage) =>{
                this.inQuery = false;
                let pl: number = 0;
