...
import { IaspnetuserViewEdlg } from './../edlg/aspnetuser-view-edlg.interface';
...
export class AspnetuserViewLformComponent implements OnInit, AfterViewInit, IEventEmitterPub, IItemHeightData {
    ...
    onAdd(sender: AspnetuserViewSformComponent) {
        let locdata: IaspnetuserViewEdlg = {
            title: 'Add item',
        ...
        let dialogRef = this.dialog.open(AspnetuserViewEdlgComponent, {
              data: locdata,
              maxWidth: mw,
              width: w,
            });
