...
@Component({
  selector: 'app-lit-book-view-lform',
  templateUrl: './lit-book-view-lform.component.html',
  styleUrls: ['./lit-book-view-lform.component.css']
})
export class LitBookViewLformComponent implements OnInit, AfterViewInit, IEventEmitterPub, IItemHeightData {
    ...
    constructor(private  frmRootSrv: LitBookViewService, protected appGlblSettings: AppGlblSettingsService, public dialog: MatDialog, private cd: ChangeDetectorRef) {
    }
    permMask: number = 0;
    ngOnInit() {
