...
import { IaspnetrolemaskViewEdlg } from './../edlg/aspnetrolemask-view-edlg.interface';
import { AspnetrolemaskViewEdlgComponent } from './../edlg/aspnetrolemask-view-edlg.component';


@Component({
  selector: 'app-aspnetrolemask-view-lform',
  templateUrl: './aspnetrolemask-view-lform.component.html',
  styleUrls: ['./aspnetrolemask-view-lform.component.css']
})
export class AspnetrolemaskViewLformComponent implements OnInit, AfterViewInit, IEventEmitterPub, IItemHeightData {
    ...
    constructor(private  frmRootSrv: AspnetrolemaskViewService, protected appGlblSettings: AppGlblSettingsService, public dialog: MatDialog, private cd: ChangeDetectorRef) {
    }
    permMask: number = 0;
    ngOnInit() {
    ...
    onAdd(sender: AspnetrolemaskViewSformComponent) {
        let locdata: IaspnetrolemaskViewEdlg = {
            title: 'Add item',
        ...
        let dialogRef = this.dialog.open(AspnetrolemaskViewEdlgComponent, {
              data: locdata,
              maxWidth: mw,
              width: w,
            });
