...
import { ILitAuthorViewEdlg } from './../edlg/lit-author-view-edlg.interface';
import { LitAuthorViewEdlgComponent } from './../edlg/lit-author-view-edlg.component';


@Component({
  selector: 'app-lit-author-view-lform',
  templateUrl: './lit-author-view-lform.component.html',
  styleUrls: ['./lit-author-view-lform.component.css']
})
export class LitAuthorViewLformComponent implements OnInit, AfterViewInit, IEventEmitterPub, IItemHeightData {
    ...
    constructor(private  frmRootSrv: LitAuthorViewService, protected appGlblSettings: AppGlblSettingsService, public dialog: MatDialog, private cd: ChangeDetectorRef) {
    }
    permMask: number = 0;
    ngOnInit() {
    ...
    onAdd(sender: LitAuthorViewSformComponent) {
        let locdata: ILitAuthorViewEdlg = {
            title: 'Add item',
        ...
        let dialogRef = this.dialog.open(LitAuthorViewEdlgComponent, {
              data: locdata,
              maxWidth: mw,
              width: w,
            });
    ...
    onDelete(e: ILitAuthorView , sender: LitAuthorViewSformComponent ) {
        let locdata: ILitAuthorViewEdlg = {
            title: 'Delete item',
            hiddenFilter: this.hiddenFilter,
