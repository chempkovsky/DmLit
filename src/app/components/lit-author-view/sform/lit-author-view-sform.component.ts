...
@Component({
  selector: 'app-lit-author-view-sform',
  templateUrl: './lit-author-view-sform.component.html',
  styleUrls: ['./lit-author-view-sform.component.css']
})
export class LitAuthorViewSformComponent implements OnInit, AfterViewInit, IEventEmitterPub, IItemHeightData {
    ...
    public dataSource: Array<ILitAuthorView> = [];
    matPaginatorLen: number = 0;
    matPaginatorPageSize: number = 10;
    matPaginatorPageSizeOptions: Array<number> = [10, 25, 50, 100];
    displayedColumns:  Array<string> = ['selectAction', 'authorId', 'firstName', 'lastName', 'birthDate', 'deathDate', 'cCountryName', 'menuAction'];
    ...
    filterDefs: Array<IWebServiceFilterDef> = [
            {fltrName: 'authorId', fltrCaption: 'Id of the Author',  fltrDataType: 'int32', fltrMaxLen: null, fltrMin: null, fltrMax: null }
           ,  {fltrName: 'firstName', fltrCaption: 'First Name',  fltrDataType: 'string', fltrMaxLen: 16, fltrMin: null, fltrMax: null }
           ,  {fltrName: 'lastName', fltrCaption: 'Last Name',  fltrDataType: 'string', fltrMaxLen: 30, fltrMin: null, fltrMax: null }
           ,  {fltrName: 'birthDate', fltrCaption: 'Birth Date',  fltrDataType: 'datetime', fltrMaxLen: null, fltrMin: null, fltrMax: null }
           ,  {fltrName: 'deathDate', fltrCaption: 'Birth Date',  fltrDataType: 'datetime', fltrMaxLen: null, fltrMin: null, fltrMax: null }
           ,  {fltrName: 'iso3CntrRef', fltrCaption: 'Birth Country Iso 3 code',  fltrDataType: 'string', fltrMaxLen: 3, fltrMin: null, fltrMax: null }
           ,  {fltrName: 'iso2CntrRef', fltrCaption: 'Iso 2 code',  fltrDataType: 'string', fltrMaxLen: 3, fltrMin: null, fltrMax: null }
           ,  {fltrName: 'cCountryName', fltrCaption: 'Birth Country',  fltrDataType: 'string', fltrMaxLen: 40, fltrMin: null, fltrMax: null }
        ];
    ...
    public currentRow: ILitAuthorView | null = null;
    @Output('selected-row') selectedRow: EventEmitter<ILitAuthorView> = new EventEmitter<ILitAuthorView>();
    @Output('apply-filter') applyFilter: EventEmitter<LitAuthorViewSformComponent> = new EventEmitter<LitAuthorViewSformComponent>();


    constructor(private  frmRootSrv: LitAuthorViewService, protected appGlblSettings: AppGlblSettingsService, protected dialog: MatDialog, private cd: ChangeDetectorRef) {
    }
    ...
    onHiddenFilter() {
        ...
        if(!isDsbl) {
            lcFltrDfs.push({fltrName: 'cCountryName', fltrCaption: 'Birth Country',  fltrDataType: 'string', fltrMaxLen: 40, fltrMin: null, fltrMax: null });
    ...
    onFilter() {
        let flt: ILitAuthorViewFilter = { page: this.currentPageIndex, pagesize: this.currentPageSize };
        ...
        this.frmRootSrv.getwithfilter(flt)
            .subscribe((v: ILitAuthorViewPage) =>{
                this.inQuery = false;
                let pl: number = 0;
                ...
                let currow: ILitAuthorView | null = null;
    ...
    rowCommand(e: ILitAuthorView, id: string) {
