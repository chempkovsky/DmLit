...
@Component({
  selector: 'app-lit-author-view-rdlist',
  templateUrl: './lit-author-view-rdlist.component.html',
  styleUrls: ['./lit-author-view-rdlist.component.css']
})
export class LitAuthorViewRdlistComponent implements OnInit, IEventEmitterPub, IItemHeightData {
