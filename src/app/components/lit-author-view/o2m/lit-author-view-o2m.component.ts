...
@Component({
  selector: 'app-lit-author-view-o2m',
  templateUrl: './lit-author-view-o2m.component.html',
  styleUrls: ['./lit-author-view-o2m.component.css']
})
export class LitAuthorViewO2mComponent implements IEventEmitterPub {
        ...
        let msk: number = 0;
            ...
            if( (msk & 1) === 1 ) {
                this.detailViewSelModels.push({
                    ...
                    caption: 'LitManuscriptView' + ': ' + 'Author'
                });
            }
    ...
    public mstrRow: ILitAuthorView | null = null; 
        ...
        switch(this.dtlVw.viewName) {
            ...
            case 'LitManuscriptView':
                        newFlt.push({
                            ...
                            fltrDataType: 'int32',
                            fltrOperator: 'eq',
                            fltrValue: this.mstrRow.authorId
                        });
                break;  
        }
