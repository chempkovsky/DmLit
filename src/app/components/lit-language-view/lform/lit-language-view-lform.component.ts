...
@Component({
  selector: 'app-lit-language-view-lform',
  templateUrl: './lit-language-view-lform.component.html',
  styleUrls: ['./lit-language-view-lform.component.css']
})
export class LitLanguageViewLformComponent implements OnInit, AfterViewInit, IEventEmitterPub, IItemHeightData {
    ...
    constructor(private  frmRootSrv: LitLanguageViewService, protected appGlblSettings: AppGlblSettingsService, public dialog: MatDialog, private cd: ChangeDetectorRef) {
    }
    permMask: number = 0;
    ngOnInit() {
