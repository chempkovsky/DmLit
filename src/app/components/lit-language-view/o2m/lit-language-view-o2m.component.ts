...
@Component({
  selector: 'app-lit-language-view-o2m',
  templateUrl: './lit-language-view-o2m.component.html',
  styleUrls: ['./lit-language-view-o2m.component.css']
})
export class LitLanguageViewO2mComponent implements IEventEmitterPub {
        ...
        let msk: number = 0;
            ...
            if( (msk & 1) === 1 ) {
                this.detailViewSelModels.push({
                    ...
                    foreignKeyName: 'Language',
                    caption: 'LitDialectView' + ': ' + 'Language'
                });
            }
    ...
    public mstrRow: ILitLanguageView | null = null; 
