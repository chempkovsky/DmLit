...
@Component({
  selector: 'app-lit-language-view-sform',
  templateUrl: './lit-language-view-sform.component.html',
  styleUrls: ['./lit-language-view-sform.component.css']
})
export class LitLanguageViewSformComponent implements OnInit, AfterViewInit, IEventEmitterPub, IItemHeightData {
    ...
    public dataSource: Array<ILitLanguageView> = [];
    matPaginatorLen: number = 0;
    matPaginatorPageSize: number = 10;
    matPaginatorPageSizeOptions: Array<number> = [10, 25, 50, 100];
    displayedColumns:  Array<string> = ['selectAction', 'iso3', 'iso2', 'languageName', 'menuAction'];
    ...
    filterDefs: Array<IWebServiceFilterDef> = [
           ...
           ,  {fltrName: 'languageName', fltrCaption: 'Language Name',  fltrDataType: 'string', fltrMaxLen: 27, fltrMin: null, fltrMax: null }
        ];
    ...
    public currentRow: ILitLanguageView | null = null;
    @Output('selected-row') selectedRow: EventEmitter<ILitLanguageView> = new EventEmitter<ILitLanguageView>();
    @Output('apply-filter') applyFilter: EventEmitter<LitLanguageViewSformComponent> = new EventEmitter<LitLanguageViewSformComponent>();


    constructor(private  frmRootSrv: LitLanguageViewService, protected appGlblSettings: AppGlblSettingsService, protected dialog: MatDialog, private cd: ChangeDetectorRef) {
    }
    ...
    onFilter() {
        let flt: ILitLanguageViewFilter = { page: this.currentPageIndex, pagesize: this.currentPageSize };
        ...
        this.frmRootSrv.getwithfilter(flt)
            .subscribe((v: ILitLanguageViewPage) =>{
                this.inQuery = false;
                let pl: number = 0;
                ...
                let currow: ILitLanguageView | null = null;
    ...
    onSelectRow(e: ILitLanguageView) {
    ...
    rowCommand(e: ILitLanguageView, id: string) {
