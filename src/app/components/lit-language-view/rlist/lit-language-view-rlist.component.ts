...
@Component({
  selector: 'app-lit-language-view-rlist',
  templateUrl: './lit-language-view-rlist.component.html',
  styleUrls: ['./lit-language-view-rlist.component.css']
})
export class LitLanguageViewRlistComponent implements OnInit, IEventEmitterPub, IItemHeightData {
