...
@Component({
  selector: 'app-lit-dialect-view-lform',
  templateUrl: './lit-dialect-view-lform.component.html',
  styleUrls: ['./lit-dialect-view-lform.component.css']
})
export class LitDialectViewLformComponent implements OnInit, AfterViewInit, IEventEmitterPub, IItemHeightData {
    ...
    constructor(private  frmRootSrv: LitDialectViewService, protected appGlblSettings: AppGlblSettingsService, public dialog: MatDialog, private cd: ChangeDetectorRef) {
    }
    permMask: number = 0;
    ngOnInit() {
