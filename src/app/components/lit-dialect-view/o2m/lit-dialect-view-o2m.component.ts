...
@Component({
  selector: 'app-lit-dialect-view-o2m',
  templateUrl: './lit-dialect-view-o2m.component.html',
  styleUrls: ['./lit-dialect-view-o2m.component.css']
})
export class LitDialectViewO2mComponent implements IEventEmitterPub {
        ...
        let msk: number = 0;
            ...
            if( (msk & 1) === 1 ) {
                this.detailViewSelModels.push({
                    ...
                    foreignKeyName: 'Dialect',
                    caption: 'LitManuscriptView' + ': ' + 'Dialect'
                });
            }
    ...
    public mstrRow: ILitDialectView | null = null; 
        ...
        switch(this.dtlVw.viewName) {
            ...
            case 'LitManuscriptView':
                        newFlt.push({
                            ...
                            fltrDataType: 'string',
                            fltrOperator: 'eq',
                            fltrValue: this.mstrRow.dialectId
                        });
                break;  
        }
