...
@Component({
  selector: 'app-lit-dialect-view-rlist',
  templateUrl: './lit-dialect-view-rlist.component.html',
  styleUrls: ['./lit-dialect-view-rlist.component.css']
})
export class LitDialectViewRlistComponent implements OnInit, IEventEmitterPub, IItemHeightData {
