...
@Component({
  selector: 'app-lit-edition-view-o2m',
  templateUrl: './lit-edition-view-o2m.component.html',
  styleUrls: ['./lit-edition-view-o2m.component.css']
})
export class LitEditionViewO2mComponent implements IEventEmitterPub {
        ...
        let msk: number = 0;
            ...
            if( (msk & 1) === 1 ) {
                this.detailViewSelModels.push({
                    ...
                    foreignKeyName: 'Edition',
                    caption: 'LitBookView' + ': ' + 'Edition'
                });
            }
    ...
    public mstrRow: ILitEditionView | null = null; 
        ...
        switch(this.dtlVw.viewName) {
            ...
            case 'LitBookView':
                        newFlt.push({
                            ...
                            fltrDataType: 'int32',
                            fltrOperator: 'eq',
                            fltrValue: this.mstrRow.editionId
                        });
                break;  
        }
