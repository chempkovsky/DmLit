...
@Component({
  selector: 'app-lit-edition-view-lform',
  templateUrl: './lit-edition-view-lform.component.html',
  styleUrls: ['./lit-edition-view-lform.component.css']
})
export class LitEditionViewLformComponent implements OnInit, AfterViewInit, IEventEmitterPub, IItemHeightData {
    ...
    constructor(private  frmRootSrv: LitEditionViewService, protected appGlblSettings: AppGlblSettingsService, public dialog: MatDialog, private cd: ChangeDetectorRef) {
    }
    permMask: number = 0;
    ngOnInit() {
