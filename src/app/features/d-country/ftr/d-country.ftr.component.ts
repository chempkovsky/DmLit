...
@Component({
  selector: 'app-d-country-ftr',
  templateUrl: './d-country.ftr.component.html',
  styleUrls: ['./d-country.ftr.component.css']
})
export class DCountryFtrComponent  {
    ...
    ngOnInit(): void {
        let msk: number = 0;
        msk = this.appGlblSettings.getViewModelMask('LitCountryView');
