...
@Component({
  selector: 'app-d-genre-ftr',
  templateUrl: './d-genre.ftr.component.html',
  styleUrls: ['./d-genre.ftr.component.css']
})
export class DGenreFtrComponent  {
    ...
    ngOnInit(): void {
        let msk: number = 0;
        msk = this.appGlblSettings.getViewModelMask('LitGenreView');
