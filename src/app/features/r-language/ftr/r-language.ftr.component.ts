...
@Component({
  selector: 'app-r-language-ftr',
  templateUrl: './r-language.ftr.component.html',
  styleUrls: ['./r-language.ftr.component.css']
})
export class RLanguageFtrComponent  {
    ...
    ngOnInit(): void {
        let msk: number = 0;
        msk = this.appGlblSettings.getViewModelMask('LitLanguageView');
