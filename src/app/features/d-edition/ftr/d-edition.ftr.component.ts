...
@Component({
  selector: 'app-d-edition-ftr',
  templateUrl: './d-edition.ftr.component.html',
  styleUrls: ['./d-edition.ftr.component.css']
})
export class DEditionFtrComponent  {
    ...
    ngOnInit(): void {
        let msk: number = 0;
        msk = this.appGlblSettings.getViewModelMask('LitEditionView');
